...
let [errorBack, setErrorBack]=useState('');
  ...
  const handelData = (e) => {
    ...
    setUser({ ...user, [name]: value }); // Corrected this line
    console.log(user);
  };
  ...
  const sendData = async (e) => {
    e.preventDefault();
    setLoader(true);
    const validationErrors = validationUserData(user);
  ...
  return (
    ...
    <div className="row flex-nowrap">
      ...
      <form onSubmit={sendData}>
          ...
          <Input errors={errors} id={'username'} title={'Name'} type={'text'} name={'name'} handelData={handelData} />
          <Input errors={errors} id={'email'} title={'Email'} type={'email'} name={'email'} handelData={handelData} />
          <Input errors={errors} id={'password'} title={'Password'} type={'password'} name={'password'} handelData={handelData}/>
